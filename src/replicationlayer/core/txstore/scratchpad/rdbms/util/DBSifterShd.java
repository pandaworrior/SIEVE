...
public class DBSifterShd extends DBShadowOperation{
	...
	/* (non-Javadoc)
	 * @see replicationlayer.core.txstore.scratchpad.rdbms.util.DBShadowOperation#encode(java.io.DataOutputStream)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see replicationlayer.core.txstore.scratchpad.rdbms.util.DBShadowOperation#execute(replicationlayer.core.txstore.scratchpad.rdbms.IDatabase)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see replicationlayer.core.txstore.scratchpad.rdbms.util.DBShadowOperation#executeShadow(replicationlayer.core.txstore.scratchpad.rdbms.IDefDatabase)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see replicationlayer.core.txstore.scratchpad.rdbms.util.DBShadowOperation#isQuery()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see replicationlayer.core.txstore.scratchpad.rdbms.util.DBShadowOperation#registerIndividualOperations()
	 */
	@Override
