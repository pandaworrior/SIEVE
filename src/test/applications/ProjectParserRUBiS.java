 ...
 */
public class ProjectParserRUBiS {
	...
	public static void main(String[] args) throws Exception {
		...
		String srcDirPath = "/var/tmp/workspace/georeplication/applications/RUBiS";
		ProjectParser pjsParser = new ProjectParser(srcDirPath,
				"RUBiSStaticAnalysis");
		//pjsParser.addFileToFileFilter("database");
		//pjsParser.addFileToFileFilter("beans");
		//pjsParser.addFileToFileFilter("Client");
