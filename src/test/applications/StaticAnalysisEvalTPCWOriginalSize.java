 ...
 */
public class StaticAnalysisEvalTPCWOriginalSize {
	
	public static String outputFile = "ResultOfStaticAnalysisOfTPCW_Original_Size";
	...
	public static double[] createWP() {
		...
		System.out.println("latency for template " + latencyOfCreatingTemplates + " latency for wp " + latencyOfGeneratingWP);
	...
	public static void runOriginal(String dir) {
		setSrcDirPath(dir);
