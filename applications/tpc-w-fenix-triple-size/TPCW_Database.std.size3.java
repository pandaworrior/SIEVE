...
public class TPCW_Database {
    ...
    public static final int maxConn = Integer.parseInt("@jdbc.connPoolMax@");
 ...
 // Get a connection from the pool.
    ...
    // Return a connection to the pool.
    public static synchronized void returnConnection1(Connection con)
    throws java.sql.SQLException
    {	
	if (!use_connection_pool) {
	    con.close();
 ...
 // Return a connection to the pool.
    public static synchronized void returnConnection2(Connection con)
    throws java.sql.SQLException
    {	
	if (!use_connection_pool) {
	    con.close();
 ...
 // Get a new connection to DB2
    public static Connection getNewConnection2() {
	try {
	    Class.forName(driverName);
	    // Class.forName("postgresql.Driver");
    ...
    public static <T> T withTransaction1(tx.TransactionalCommand<T> command) {
    	try {
    	    while (true) {
    ...
    public static <T> T withTransaction2(tx.TransactionalCommand<T> command) {
    	try {
    	    while (true) {
    ...
    public static String[] getName1(final int c_id) {
    	String[] name = withTransaction1(new tx.TransactionalCommand<String[]>() {
    		public String[] doIt1(Connection con) throws SQLException {
    		    return getName1(con, c_id);
    		}
    	    });
    	return name;
        }
    
    public static String[] getName2(final int c_id) {
    	String[] name = withTransaction2(new tx.TransactionalCommand<String[]>() {
    		public String[] doIt2(Connection con) throws SQLException {
    		    return getName2(con, c_id);
    		}
    	    });
    	return name;
        }
    ...
    private static String[] getName1(Connection con, int c_id) throws SQLException {
    	String name[] = new String[2];
    	    PreparedStatement get_name = con.prepareStatement
    		("SELECT c_fname,c_lname FROM customer WHERE c_id = ?");
    ...
    private static String[] getName2(Connection con, int c_id) throws SQLException {
    	String name[] = new String[2];
    	    PreparedStatement get_name = con.prepareStatement
    		("SELECT c_fname,c_lname FROM customer WHERE c_id = ?");
    ...
    public static Book getBook1(final int i_id) {
    	Book book = withTransaction1(new tx.TransactionalCommand<Book>() {
    		public Book doIt1(Connection con) throws SQLException {
    		    return getBook1(con, i_id);
    		}
    	    });
    	return book;
        }
    
    public static Book getBook2(final int i_id) {
    	Book book = withTransaction2(new tx.TransactionalCommand<Book>() {
    		public Book doIt2(Connection con) throws SQLException {
    		    return getBook2(con, i_id);
    		}
    	    });
    	return book;
        }
    ...
    private static Book getBook1(Connection con, int i_id) throws SQLException {
    	Book book = null;
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM item,author WHERE item.i_a_id = author.a_id AND i_id = ?");
    ...
    private static Book getBook2(Connection con, int i_id) throws SQLException {
    	Book book = null;
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM item,author WHERE item.i_a_id = author.a_id AND i_id = ?");
    ...
    public static Customer getCustomer1(final String UNAME){
    	Customer customer = withTransaction1(new tx.TransactionalCommand<Customer>() {
    		public Customer doIt1(Connection con) throws SQLException {
    		    return getCustomer1(con, UNAME);
    		}
    	    });
    	return customer;
        }
    
    public static Customer getCustomer2(final String UNAME){
    	Customer customer = withTransaction2(new tx.TransactionalCommand<Customer>() {
    		public Customer doIt2(Connection con) throws SQLException {
    		    return getCustomer2(con, UNAME);
    		}
    	    });
    	return customer;
        }
    ...
    private static Customer getCustomer1(Connection con, String UNAME) throws SQLException {
    	Customer cust = null;
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM customer, address, country WHERE customer.c_addr_id = address.addr_id AND address.addr_co_id = country.co_id AND customer.c_uname = ?");
    ...
    private static Customer getCustomer2(Connection con, String UNAME) throws SQLException {
    	Customer cust = null;
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM customer, address, country WHERE customer.c_addr_id = address.addr_id AND address.addr_co_id = country.co_id AND customer.c_uname = ?");
    ...
    public static Vector doSubjectSearch1(final String search_key) {
    	Vector Vector = withTransaction1(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt1(Connection con) throws SQLException {
    		    return doSubjectSearch1(con, search_key);
    		}
    	    });
    	return Vector;
        }
    
    public static Vector doSubjectSearch2(final String search_key) {
    	Vector Vector = withTransaction2(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt2(Connection con) throws SQLException {
    		    return doSubjectSearch2(con, search_key);
    		}
    	    });
    	return Vector;
        }
    ...
    private static Vector doSubjectSearch1(Connection con, String search_key) throws SQLException {
    	Vector vec = new Vector();
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM item, author WHERE item.i_a_id = author.a_id AND item.i_subject = ? ORDER BY item.i_title limit 50");
    ...
    private static Vector doSubjectSearch2(Connection con, String search_key) throws SQLException {
    	Vector vec = new Vector();
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM item, author WHERE item.i_a_id = author.a_id AND item.i_subject = ? ORDER BY item.i_title limit 50");
    ...
    public static Vector doTitleSearch1(final String search_key) {
    	Vector vector = withTransaction1(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt1(Connection con) throws SQLException {
    		    return doTitleSearch1(con, search_key);
    		}
    	    });
    	return vector;
        }
    
    public static Vector doTitleSearch2(final String search_key) {
    	Vector vector = withTransaction2(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt2(Connection con) throws SQLException {
    		    return doTitleSearch2(con, search_key);
    		}
    	    });
    	return vector;
        }
    ...
    private static Vector doTitleSearch1(Connection con, String search_key) throws SQLException {
    	Vector vec = new Vector();
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM item, author WHERE item.i_a_id = author.a_id AND substring(soundex(item.i_title),1,4)=substring(soundex(?),1,4) ORDER BY item.i_title limit 50");
    ...
    private static Vector doTitleSearch2(Connection con, String search_key) throws SQLException {
    	Vector vec = new Vector();
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM item, author WHERE item.i_a_id = author.a_id AND substring(soundex(item.i_title),1,4)=substring(soundex(?),1,4) ORDER BY item.i_title limit 50");
    ...
    public static Vector doAuthorSearch1(final String search_key) {
    	Vector vector = withTransaction1(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt1(Connection con) throws SQLException {
    		    return doAuthorSearch1(con, search_key);
    		}
    	    });
    	return vector;
        }
    
    public static Vector doAuthorSearch2(final String search_key) {
    	Vector vector = withTransaction2(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt2(Connection con) throws SQLException {
    		    return doAuthorSearch2(con, search_key);
    		}
    	    });
    	return vector;
        }
    ...
    private static Vector doAuthorSearch1(Connection con, String search_key) throws SQLException {
    	Vector vec = new Vector();
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM author, item WHERE substring(soundex(author.a_lname),1,4)=substring(soundex(?),1,4) AND item.i_a_id = author.a_id ORDER BY item.i_title limit 50");
    ...
    private static Vector doAuthorSearch2(Connection con, String search_key) throws SQLException {
    	Vector vec = new Vector();
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT * FROM author, item WHERE substring(soundex(author.a_lname),1,4)=substring(soundex(?),1,4) AND item.i_a_id = author.a_id ORDER BY item.i_title limit 50");
    ...
    public static Vector getNewProducts1(final String subject) {
    	Vector vector = withTransaction1(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt1(Connection con) throws SQLException {
    		    return getNewProducts1(con, subject);
    		}
    	    });
    	return vector;
        }
    
    public static Vector getNewProducts2(final String subject) {
    	Vector vector = withTransaction2(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt2(Connection con) throws SQLException {
    		    return getNewProducts2(con, subject);
    		}
    	    });
    	return vector;
        }
    ...
    private static Vector getNewProducts1(Connection con, String subject) throws SQLException {
    	Vector vec = new Vector();  // Vector of Books
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT i_id, i_title, a_fname, a_lname " +		 "FROM item, author " +		 "WHERE item.i_a_id = author.a_id " +		 "AND item.i_subject = ? " +		 "ORDER BY item.i_pub_date DESC,item.i_title " +		 "limit 50");
    ...
    private static Vector getNewProducts2(Connection con, String subject) throws SQLException {
    	Vector vec = new Vector();  // Vector of Books
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT i_id, i_title, a_fname, a_lname " +		 "FROM item, author " +		 "WHERE item.i_a_id = author.a_id " +		 "AND item.i_subject = ? " +		 "ORDER BY item.i_pub_date DESC,item.i_title " +		 "limit 50");
    ...
    public static Vector getBestSellers1(final String subject) {
    	Vector vector = withTransaction1(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt1(Connection con) throws SQLException {
    		    return getBestSellers1(con, subject);
    		}
    	    });
    	return vector;
        }
    
    public static Vector getBestSellers2(final String subject) {
    	Vector vector = withTransaction2(new tx.TransactionalCommand<Vector>() {
    		public Vector doIt2(Connection con) throws SQLException {
    		    return getBestSellers2(con, subject);
    		}
    	    });
    	return vector;
        }
    ...
    private static Vector getBestSellers1(Connection con, String subject) throws SQLException {
    	Vector vec = new Vector();  // Vector of Books
    	    //The following is the original, unoptimized best sellers query.
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT i_id, i_title, a_fname, a_lname " +		 "FROM item, author, order_line " +		 "WHERE item.i_id = order_line.ol_i_id " +		 "AND item.i_a_id = author.a_id " +		 "AND order_line.ol_o_id > (SELECT MAX(o_id)-3333 FROM orders) " +		 "AND item.i_subject = ? " +		 "GROUP BY i_id, i_title, a_fname, a_lname " +		 "ORDER BY SUM(ol_qty) DESC " +		 "limit 50");
    ...
    private static Vector getBestSellers2(Connection con, String subject) throws SQLException {
    	Vector vec = new Vector();  // Vector of Books
    	    //The following is the original, unoptimized best sellers query.
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT i_id, i_title, a_fname, a_lname " +		 "FROM item, author, order_line " +		 "WHERE item.i_id = order_line.ol_i_id " +		 "AND item.i_a_id = author.a_id " +		 "AND order_line.ol_o_id > (SELECT MAX(o_id)-3333 FROM orders) " +		 "AND item.i_subject = ? " +		 "GROUP BY i_id, i_title, a_fname, a_lname " +		 "ORDER BY SUM(ol_qty) DESC " +		 "limit 50");
    ...
    public static void getRelated1(final int i_id, final Vector i_id_vec, final Vector i_thumbnail_vec) {
    	withTransaction1(new tx.TransactionalCommand<Void>() {
    		public Void doIt1(Connection con) throws SQLException {
    		    getRelated1(con, i_id, i_id_vec, i_thumbnail_vec);
    		    return VOID;
    		}
    	    });
        }
    
    public static void getRelated2(final int i_id, final Vector i_id_vec, final Vector i_thumbnail_vec) {
    	withTransaction2(new tx.TransactionalCommand<Void>() {
    		public Void doIt2(Connection con) throws SQLException {
    		    getRelated2(con, i_id, i_id_vec, i_thumbnail_vec);
    		    return VOID;
    		}
    	    });
        }
    ...
    private static void getRelated1(Connection con, int i_id, Vector i_id_vec, Vector i_thumbnail_vec) throws SQLException {
	    PreparedStatement statement = con.prepareStatement
		("SELECT J.i_id,J.i_thumbnail from item I, item J where (I.i_related1 = J.i_id or I.i_related2 = J.i_id or I.i_related3 = J.i_id or I.i_related4 = J.i_id or I.i_related5 = J.i_id) and I.i_id = ?");
    ...
    private static void getRelated2(Connection con, int i_id, Vector i_id_vec, Vector i_thumbnail_vec) throws SQLException {
	    PreparedStatement statement = con.prepareStatement
		("SELECT J.i_id,J.i_thumbnail from item I, item J where (I.i_related1 = J.i_id or I.i_related2 = J.i_id or I.i_related3 = J.i_id or I.i_related4 = J.i_id or I.i_related5 = J.i_id) and I.i_id = ?");
    ...
    public static void adminUpdate1(final int i_id, final double cost, final String image, final String thumbnail) {
    	withTransaction1(new tx.TransactionalCommand<Void>() {
    		public Void doIt1(Connection con) throws SQLException {
    		    adminUpdate1(con, i_id, cost, image, thumbnail);
    		    return VOID;
    		}
    	    });
        }
    
    public static void adminUpdate2(final int i_id, final double cost, final String image, final String thumbnail) {
    	withTransaction2(new tx.TransactionalCommand<Void>() {
    		public Void doIt2(Connection con) throws SQLException {
    		    adminUpdate2(con, i_id, cost, image, thumbnail);
    		    return VOID;
    		}
    	    });
        }
    ...
    private static void adminUpdate1(Connection con, int i_id, double cost, String image, String thumbnail) throws SQLException {
	    PreparedStatement statement = con.prepareStatement
		("UPDATE item SET i_cost = ?, i_image = ?, i_thumbnail = ?, i_pub_date = CURRENT_DATE WHERE i_id = ?");
    ...
    private static void adminUpdate2(Connection con, int i_id, double cost, String image, String thumbnail) throws SQLException {
	    PreparedStatement statement = con.prepareStatement
		("UPDATE item SET i_cost = ?, i_image = ?, i_thumbnail = ?, i_pub_date = CURRENT_DATE WHERE i_id = ?");
    ...
    public static String GetUserName1(final int C_ID){
    	String string = withTransaction1(new tx.TransactionalCommand<String>() {
    		public String doIt1(Connection con) throws SQLException {
    		    return GetUserName1(con, C_ID);
    		}
    	    });
    	return string;
        }
    
    public static String GetUserName2(final int C_ID){
    	String string = withTransaction2(new tx.TransactionalCommand<String>() {
    		public String doIt2(Connection con) throws SQLException {
    		    return GetUserName2(con, C_ID);
    		}
    	    });
    	return string;
        }
    ...
    private static String GetUserName1(Connection con, int C_ID)throws SQLException {
    	String u_name = null;
    	    PreparedStatement get_user_name = con.prepareStatement
    		("SELECT c_uname FROM customer WHERE c_id = ?");
    ...
    private static String GetUserName2(Connection con, int C_ID)throws SQLException {
    	String u_name = null;
    	    PreparedStatement get_user_name = con.prepareStatement
    		("SELECT c_uname FROM customer WHERE c_id = ?");
    ...
    public static String GetPassword1(final String C_UNAME){
    	String string = withTransaction1(new tx.TransactionalCommand<String>() {
    		public String doIt1(Connection con) throws SQLException {
    		    return GetPassword1(con, C_UNAME);
    		}
    	    });
    	return string;
        }
    
    public static String GetPassword2(final String C_UNAME){
    	String string = withTransaction2(new tx.TransactionalCommand<String>() {
    		public String doIt2(Connection con) throws SQLException {
    		    return GetPassword2(con, C_UNAME);
    		}
    	    });
    	return string;
        }
    ...
    private static String GetPassword1(Connection con, String C_UNAME)throws SQLException {
    	String passwd = null;
    	    PreparedStatement get_passwd = con.prepareStatement
    		("SELECT c_passwd FROM customer WHERE c_uname = ?");
    ...
    private static String GetPassword2(Connection con, String C_UNAME)throws SQLException {
    	String passwd = null;
    	    PreparedStatement get_passwd = con.prepareStatement
    		("SELECT c_passwd FROM customer WHERE c_uname = ?");
  ...
  //This function gets the value of I_RELATED1 for the row of
    //the item table corresponding to I_ID
    private static int getRelated11(int I_ID, Connection con) throws SQLException {
	int related1 = -1;
	    PreparedStatement statement = con.prepareStatement
		("SELECT i_related1 FROM item where i_id = ?");
	    statement.setInt(1, I_ID);
    ...
    private static int getRelated12(int I_ID, Connection con) throws SQLException {
    	int related1 = -1;
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT i_related1 FROM item where i_id = ?");
    	    statement.setInt(1, I_ID);
    ...
    public static Order GetMostRecentOrder1(final String c_uname, final Vector order_lines){
	Order order = withTransaction1(new tx.TransactionalCommand<Order>() {
		public Order doIt1(Connection con) throws SQLException {
		    return GetMostRecentOrder1(con, c_uname, order_lines);
		}
	    });
	return order;
    }
    
    public static Order GetMostRecentOrder2(final String c_uname, final Vector order_lines){
    	Order order = withTransaction2(new tx.TransactionalCommand<Order>() {
    		public Order doIt2(Connection con) throws SQLException {
    		    return GetMostRecentOrder2(con, c_uname, order_lines);
    		}
    	    });
    	return order;
        }
    ...
    private static Order GetMostRecentOrder1(Connection con, String c_uname, Vector order_lines)throws SQLException {
	    order_lines.removeAllElements();
	    int order_id;
	    Order order;
    ...
    private static Order GetMostRecentOrder2(Connection con, String c_uname, Vector order_lines)throws SQLException {
	    order_lines.removeAllElements();
	    int order_id;
	    Order order;
 ...
 // Called from: TPCW_shopping_cart_interaction 
    public static int createEmptyCart1(){
	Integer integer = withTransaction1(new tx.TransactionalCommand<Integer>() {
		public Integer doIt1(Connection con) throws SQLException {
		    return createEmptyCart1(con);
		}
	    });
	return integer;
    }
    
    public static int createEmptyCart2(){
    	Integer integer = withTransaction2(new tx.TransactionalCommand<Integer>() {
    		public Integer doIt2(Connection con) throws SQLException {
    		    return createEmptyCart2(con);
    		}
    	    });
    	return integer;
        }
    ...
    private static int createEmptyCart1(Connection con)throws SQLException {
    	int SHOPPING_ID = 0;
    	//	boolean success = false;
    ...
    private static int createEmptyCart2(Connection con)throws SQLException {
    	int SHOPPING_ID = 0;
    	//	boolean success = false;
    ...
    public static Cart doCart1(final int SHOPPING_ID, final Integer I_ID, final Vector ids, final Vector quantities) {	
    	Cart cart = withTransaction1(new tx.TransactionalCommand<Cart>() {
    		public Cart doIt1(Connection con) throws SQLException {
    		    return doCart1(con, SHOPPING_ID, I_ID, ids, quantities);
    		}
    	    });
    	return cart;
        }
    
    public static Cart doCart2(final int SHOPPING_ID, final Integer I_ID, final Vector ids, final Vector quantities) {	
    	Cart cart = withTransaction2(new tx.TransactionalCommand<Cart>() {
    		public Cart doIt2(Connection con) throws SQLException {
    		    return doCart2(con, SHOPPING_ID, I_ID, ids, quantities);
    		}
    	    });
    	return cart;
        }
    ...
    private static Cart doCart1(Connection con, int SHOPPING_ID, Integer I_ID, Vector ids, Vector quantities) throws SQLException {
	    Cart cart = null;

	    if (I_ID != null) {
		addItem1(con, SHOPPING_ID, I_ID.intValue()); 
	    }
	    refreshCart1(con, SHOPPING_ID, ids, quantities);
	    addRandomItemToCartIfNecessary1(con, SHOPPING_ID);
	    resetCartTime1(con, SHOPPING_ID);
	    cart = TPCW_Database.getCart1(con, SHOPPING_ID, 0.0);
	    
	return cart;
    }
    
    private static Cart doCart2(Connection con, int SHOPPING_ID, Integer I_ID, Vector ids, Vector quantities) throws SQLException {
	    Cart cart = null;

	    if (I_ID != null) {
		addItem2(con, SHOPPING_ID, I_ID.intValue()); 
	    }
	    refreshCart2(con, SHOPPING_ID, ids, quantities);
	    addRandomItemToCartIfNecessary2(con, SHOPPING_ID);
	    resetCartTime2(con, SHOPPING_ID);
	    cart = TPCW_Database.getCart2(con, SHOPPING_ID, 0.0);
    ...
    private static void addItem1(Connection con, int SHOPPING_ID, int I_ID) throws SQLException {
	    PreparedStatement find_entry = con.prepareStatement
		("SELECT scl_qty FROM shopping_cart_line WHERE scl_sc_id = ? AND scl_i_id = ?");
    ...
    private static void addItem2(Connection con, int SHOPPING_ID, int I_ID) throws SQLException {
	    PreparedStatement find_entry = con.prepareStatement
		("SELECT scl_qty FROM shopping_cart_line WHERE scl_sc_id = ? AND scl_i_id = ?");
    ...
    private static void refreshCart1(Connection con, int SHOPPING_ID, Vector ids, 
		    Vector quantities) throws SQLException {
		int i;
		for(i = 0; i < ids.size(); i++){
			String I_IDstr = (String) ids.elementAt(i);
    ...
    private static void refreshCart2(Connection con, int SHOPPING_ID, Vector ids, 
		    Vector quantities) throws SQLException {
		int i;
		for(i = 0; i < ids.size(); i++){
			String I_IDstr = (String) ids.elementAt(i);
    ...
    private static void addRandomItemToCartIfNecessary1(Connection con, int SHOPPING_ID) throws SQLException {
    	// check and see if the cart is empty. If it's not, we do
    	// nothing.
    	int related_item = 0;
    		...
    		// Cart is empty
    		int rand_id = TPCW_Util.getRandomI_ID();
    		related_item = getRelated11(rand_id,con);
    		addItem1(con, SHOPPING_ID, related_item);
    	    }
    ...
    private static void addRandomItemToCartIfNecessary2(Connection con, int SHOPPING_ID) throws SQLException {
    	// check and see if the cart is empty. If it's not, we do
    	// nothing.
    	int related_item = 0;
    		...
    		// Cart is empty
    		int rand_id = TPCW_Util.getRandomI_ID();
    		related_item = getRelated12(rand_id,con);
    		addItem2(con, SHOPPING_ID, related_item);
    	    }
 ...
 // Only called from this class 
    private static void resetCartTime1(Connection con, int SHOPPING_ID) throws SQLException {
	    PreparedStatement statement = con.prepareStatement
		("UPDATE shopping_cart SET sc_time = CURRENT_TIMESTAMP WHERE sc_id = ?");
    ...
    private static void resetCartTime2(Connection con, int SHOPPING_ID) throws SQLException {
	    PreparedStatement statement = con.prepareStatement
		("UPDATE shopping_cart SET sc_time = CURRENT_TIMESTAMP WHERE sc_id = ?");
    ...
    public static Cart getCart1(final int SHOPPING_ID, final double c_discount) {
    	Cart cart = withTransaction1(new tx.TransactionalCommand<Cart>() {
    		public Cart doIt1(Connection con) throws SQLException {
    		    return getCart1(con, SHOPPING_ID, c_discount);
    		}
    	    });
    	return cart;
        }
    
    public static Cart getCart2(final int SHOPPING_ID, final double c_discount) {
    	Cart cart = withTransaction2(new tx.TransactionalCommand<Cart>() {
    		public Cart doIt2(Connection con) throws SQLException {
    		    return getCart2(con, SHOPPING_ID, c_discount);
    		}
    	    });
    	return cart;
        }
    ...
    private static Cart getCart1(Connection con, int SHOPPING_ID, double c_discount) throws SQLException {
	Cart mycart = null;
	    PreparedStatement get_cart = con.prepareStatement
		("SELECT * " + 		 "FROM shopping_cart_line, item " + 		 "WHERE scl_i_id = item.i_id AND scl_sc_id = ?");
	    get_cart.setInt(1, SHOPPING_ID);
    ...
    private static Cart getCart2(Connection con, int SHOPPING_ID, double c_discount) throws SQLException {
	Cart mycart = null;
	    PreparedStatement get_cart = con.prepareStatement
		("SELECT * " + 		 "FROM shopping_cart_line, item " + 		 "WHERE scl_i_id = item.i_id AND scl_sc_id = ?");
	    get_cart.setInt(1, SHOPPING_ID);
    ...
    public static void refreshSession1(final int C_ID) {
	withTransaction1(new tx.TransactionalCommand<Void>() {
		public Void doIt1(Connection con) throws SQLException {
		    refreshSession1(con, C_ID);
		    return VOID;
		}
	    });
    }
    
    public static void refreshSession2(final int C_ID) {
	withTransaction2(new tx.TransactionalCommand<Void>() {
		public Void doIt2(Connection con) throws SQLException {
		    refreshSession2(con, C_ID);
		    return VOID;
		}
	    });
    }
    ...
    private static void refreshSession1(Connection con, int C_ID) throws SQLException {
	    PreparedStatement updateLogin = con.prepareStatement
		("UPDATE customer SET c_login = NOW(), c_expiration = (CURRENT_TIMESTAMP + INTERVAL 2 HOUR) WHERE c_id = ?");
    ...
    private static void refreshSession2(Connection con, int C_ID) throws SQLException {
	    PreparedStatement updateLogin = con.prepareStatement
		("UPDATE customer SET c_login = NOW(), c_expiration = (CURRENT_TIMESTAMP + INTERVAL 2 HOUR) WHERE c_id = ?");
    ...
    public static Customer createNewCustomer1(final Customer cust) {
	Customer customer = withTransaction1(new tx.TransactionalCommand<Customer>() {
		public Customer doIt1(Connection con) throws SQLException {
		    return createNewCustomer1(con, cust);
		}
	    });
	return customer;
    }
    
    public static Customer createNewCustomer2(final Customer cust) {
	Customer customer = withTransaction2(new tx.TransactionalCommand<Customer>() {
		public Customer doIt2(Connection con) throws SQLException {
		    return createNewCustomer2(con, cust);
		}
	    });
	return customer;
    }
    ...
    private static Customer createNewCustomer1(Connection con, Customer cust) throws SQLException {
	    // Get largest customer ID already in use.
	    ...
	    cust.addr_id = enterAddress1(con, 
					cust.addr_street1, 
					cust.addr_street2,
					cust.addr_city,
					cust.addr_state,
    ...
    private static Customer createNewCustomer2(Connection con, Customer cust) throws SQLException {
	    // Get largest customer ID already in use.
    ...
    public static BuyConfirmResult doBuyConfirm1(final int shopping_id,
			final int customer_id,
			final String cc_type,
			final long cc_number,
			final String cc_name,
			final Date cc_expiry,
			final String shipping) {
			BuyConfirmResult buyConfirmResult = withTransaction1(new tx.TransactionalCommand<BuyConfirmResult>() {
			public BuyConfirmResult doIt1(Connection con) throws SQLException {
			return doBuyConfirm1(con, shopping_id, customer_id, cc_type, cc_number, cc_name, cc_expiry, shipping);
			}
		});
		return buyConfirmResult;
	}
    
    public static BuyConfirmResult doBuyConfirm2(final int shopping_id,
			final int customer_id,
			final String cc_type,
			final long cc_number,
			final String cc_name,
			final Date cc_expiry,
			final String shipping) {
			BuyConfirmResult buyConfirmResult = withTransaction2(new tx.TransactionalCommand<BuyConfirmResult>() {
			public BuyConfirmResult doIt2(Connection con) throws SQLException {
			return doBuyConfirm2(con, shopping_id, customer_id, cc_type, cc_number, cc_name, cc_expiry, shipping);
			}
		});
		return buyConfirmResult;
	}
    ...
    private static BuyConfirmResult doBuyConfirm1(Connection con, int shopping_id, int customer_id, String cc_type, long cc_number,
			 String cc_name, Date cc_expiry, String shipping) throws SQLException {

		BuyConfirmResult result = new BuyConfirmResult();
		double c_discount = getCDiscount1(con, customer_id);
		result.cart = getCart1(con, shopping_id, c_discount);
		int ship_addr_id = getCAddr1(con, customer_id);
		result.order_id = enterOrder1(con, customer_id, result.cart, ship_addr_id, shipping, c_discount);
		enterCCXact1(con, result.order_id, cc_type, cc_number, cc_name, cc_expiry, result.cart.SC_TOTAL, ship_addr_id);
		clearCart1(con, shopping_id);
		return result;
    }
    
    private static BuyConfirmResult doBuyConfirm2(Connection con, int shopping_id, int customer_id, String cc_type, long cc_number,
			 String cc_name, Date cc_expiry, String shipping) throws SQLException {

		BuyConfirmResult result = new BuyConfirmResult();
		double c_discount = getCDiscount2(con, customer_id);
		result.cart = getCart2(con, shopping_id, c_discount);
		int ship_addr_id = getCAddr2(con, customer_id);
		result.order_id = enterOrder2(con, customer_id, result.cart, ship_addr_id, shipping, c_discount);
		enterCCXact2(con, result.order_id, cc_type, cc_number, cc_name, cc_expiry, result.cart.SC_TOTAL, ship_addr_id);
		clearCart2(con, shopping_id);
		return result;
    }
    ...
    private static BuyConfirmResult doBuyConfirm1(Connection con, int shopping_id, int customer_id, String cc_type, long cc_number,
			...
			double c_discount = getCDiscount1(con, customer_id);
			result.cart = getCart1(con, shopping_id, c_discount);
			int ship_addr_id = enterAddress1(con, street_1, street_2, city, state, zip, country);
			result.order_id = enterOrder1(con, customer_id, result.cart, ship_addr_id, shipping, c_discount);
			enterCCXact1(con, result.order_id, cc_type, cc_number, cc_name, cc_expiry, result.cart.SC_TOTAL, ship_addr_id);
			clearCart1(con, shopping_id);
			return result;
    ...
    private static BuyConfirmResult doBuyConfirm2(Connection con, int shopping_id, int customer_id, String cc_type, long cc_number,
			...
			double c_discount = getCDiscount2(con, customer_id);
			result.cart = getCart2(con, shopping_id, c_discount);
			int ship_addr_id = enterAddress2(con, street_1, street_2, city, state, zip, country);
			result.order_id = enterOrder2(con, customer_id, result.cart, ship_addr_id, shipping, c_discount);
			enterCCXact2(con, result.order_id, cc_type, cc_number, cc_name, cc_expiry, result.cart.SC_TOTAL, ship_addr_id);
			clearCart2(con, shopping_id);
			return result;
    ...
    public static double getCDiscount1(Connection con, int c_id) throws SQLException {
    	double c_discount = 0.0;
    	    // Prepare SQL
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT c_discount FROM customer WHERE customer.c_id = ?");
    ...
    public static double getCDiscount2(Connection con, int c_id) throws SQLException {
    	double c_discount = 0.0;
    	    // Prepare SQL
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT c_discount FROM customer WHERE customer.c_id = ?");
    ...
    public static int getCAddrID1(Connection con, int c_id) throws SQLException {
    	int c_addr_id = 0;
    	    // Prepare SQL
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT c_addr_id FROM customer WHERE customer.c_id = ?");
    ...
    public static int getCAddrID2(Connection con, int c_id) throws SQLException {
    	int c_addr_id = 0;
    	    // Prepare SQL
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT c_addr_id FROM customer WHERE customer.c_id = ?");
    ...
    public static int getCAddr1(Connection con, int c_id) throws SQLException {
    	int c_addr_id = 0;
    	    // Prepare SQL
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT c_addr_id FROM customer WHERE customer.c_id = ?");
    ...
    public static int getCAddr2(Connection con, int c_id) throws SQLException {
    	int c_addr_id = 0;
    	    // Prepare SQL
    	    PreparedStatement statement = con.prepareStatement
    		("SELECT c_addr_id FROM customer WHERE customer.c_id = ?");
    ...
    public static void enterCCXact1(Connection con,
			   int o_id,        // Order id
			   String cc_type,
			   long cc_number,
			   String cc_name,
    ...
    public static void enterCCXact2(Connection con,
			   int o_id,        // Order id
			   String cc_type,
			   long cc_number,
			   String cc_name,
    ...
    public static void clearCart1(Connection con, int shopping_id) throws SQLException {
	// Empties all the lines from the shopping_cart_line for the
	// shopping id.  Does not remove the actually shopping cart
	    // Prepare SQL
	    PreparedStatement statement = con.prepareStatement
    ...
    public static void clearCart2(Connection con, int shopping_id) throws SQLException {
	// Empties all the lines from the shopping_cart_line for the
	// shopping id.  Does not remove the actually shopping cart
	    // Prepare SQL
	    PreparedStatement statement = con.prepareStatement
    ...
    public static int enterAddress1(Connection con,  // Do we need to do this as part of a transaction?
			   String street1, String street2,
			   String city, String state,
			   String zip, String country) throws SQLException {
		// returns the address id of the specified address.  Adds a
    ...
    public static int enterAddress2(Connection con,  // Do we need to do this as part of a transaction?
			   String street1, String street2,
			   String city, String state,
			   String zip, String country) throws SQLException {
		// returns the address id of the specified address.  Adds a
	...
	// - Creates an entry in the 'orders' table 
		...
		("INSERT into orders (o_id, o_c_id, o_date, o_sub_total, " + 		 "o_tax, o_total, o_ship_type, o_ship_date, " + 		 "o_bill_addr_id, o_ship_addr_id, o_status) " + 		 "VALUES (?, ?, CURRENT_DATE, ?, 8.25, ?, ?, CURRENT_DATE, ?, ?, Pending)");
    ...
    public static int enterOrder1(Connection con, int customer_id, Cart cart, int ship_addr_id, String shipping, double c_discount) throws SQLException {
    	// returns the new order_id
    	int o_id = 0;
    	// - Creates an entry in the 'orders' table 
    	    PreparedStatement insert_row = con.prepareStatement
    	...
    	while(e.hasMoreElements()) {
    	    // - Creates one or more 'order_line' rows.
    	    CartLine cart_line = (CartLine) e.nextElement();
    	    addOrderLine1(con, counter, o_id, cart_line.scl_i_id, 
    			 cart_line.scl_qty, c_discount, 
    			 TPCW_Util.getRandomString(20, 100));
    	    counter++;

    	    // - Adjusts the stock for each item ordered
    	    int stock = getStock1(con, cart_line.scl_i_id);
    	    if ((stock - cart_line.scl_qty) < 10) {
    		setStock1(con, cart_line.scl_i_id, 
    			 stock - cart_line.scl_qty + 21);
    	    } else {
    		setStock1(con, cart_line.scl_i_id, stock - cart_line.scl_qty);
    	    }
    	}
    	return o_id;
        }
    
    public static int enterOrder2(Connection con, int customer_id, Cart cart, int ship_addr_id, String shipping, double c_discount) throws SQLException {
    	// returns the new order_id
    	int o_id = 0;
    	// - Creates an entry in the 'orders' table 
    	    PreparedStatement insert_row = con.prepareStatement
    	...
    	while(e.hasMoreElements()) {
    	    // - Creates one or more 'order_line' rows.
    	    CartLine cart_line = (CartLine) e.nextElement();
    	    addOrderLine2(con, counter, o_id, cart_line.scl_i_id, 
    			 cart_line.scl_qty, c_discount, 
    			 TPCW_Util.getRandomString(20, 100));
    	    counter++;

    	    // - Adjusts the stock for each item ordered
    	    int stock = getStock2(con, cart_line.scl_i_id);
    	    if ((stock - cart_line.scl_qty) < 10) {
    		setStock2(con, cart_line.scl_i_id, 
    			 stock - cart_line.scl_qty + 21);
    	    } else {
    		setStock2(con, cart_line.scl_i_id, stock - cart_line.scl_qty);
    	    }
    	}
    	return o_id;
        }
    ...
    public static void addOrderLine1(Connection con, 
		    int ol_id, int ol_o_id, int ol_i_id, 
		    int ol_qty, double ol_discount, String ol_comment) throws SQLException {
		int success = 0;
		PreparedStatement insert_row = con.prepareStatement
    ...
    public static void addOrderLine2(Connection con, 
		    int ol_id, int ol_o_id, int ol_i_id, 
		    int ol_qty, double ol_discount, String ol_comment) throws SQLException {
		int success = 0;
		PreparedStatement insert_row = con.prepareStatement
    ...
    public static int getStock1(Connection con, int i_id) throws SQLException {
    	int stock = 0;
    	    PreparedStatement get_stock = con.prepareStatement
    		("SELECT i_stock FROM item WHERE i_id = ?");
    ...
    public static int getStock2(Connection con, int i_id) throws SQLException {
    	int stock = 0;
    	    PreparedStatement get_stock = con.prepareStatement
    		("SELECT i_stock FROM item WHERE i_id = ?");
    ...
    public static void setStock1(Connection con, int i_id, int new_stock) throws SQLException {
	    PreparedStatement update_row = con.prepareStatement
		("UPDATE item SET i_stock = ? WHERE i_id = ?");
	    update_row.setInt(1, new_stock);
	    update_row.setInt(2, i_id);
    ...
    public static void setStock2(Connection con, int i_id, int new_stock) throws SQLException {
	    PreparedStatement update_row = con.prepareStatement
		("UPDATE item SET i_stock = ? WHERE i_id = ?");
	    update_row.setInt(1, new_stock);
	    update_row.setInt(2, i_id);
    ...
    public static void verifyDBConsistency1(){
    	withTransaction1(new tx.TransactionalCommand<Void>() {
    		public Void doIt1(Connection con) throws SQLException {
    		    verifyDBConsistency1(con);
    		    return VOID;
    		}
    	    });
        }
    
    public static void verifyDBConsistency2(){
    	withTransaction2(new tx.TransactionalCommand<Void>() {
    		public Void doIt2(Connection con) throws SQLException {
    		    verifyDBConsistency2(con);
    		    return VOID;
    		}
    	    });
        }
    ...
    private static void verifyDBConsistency1(Connection con) throws SQLException {
	    int this_id;
	    int id_expected = 1;
	    //First verify customer table
	    PreparedStatement get_ids = con.prepareStatement
    ...
    private static void verifyDBConsistency2(Connection con) throws SQLException {
	    int this_id;
	    int id_expected = 1;
	    //First verify customer table
	    PreparedStatement get_ids = con.prepareStatement
