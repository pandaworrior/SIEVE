...
CREATE TABLE items (
   ...
   start_date    TIMESTAMP, /*DATETIME, - doesnt carry information about timezone and may affect remote datacenters */
   end_date      TIMESTAMP, /*DATETIME, - doesnt carry information about timezone and may affect remote datacenters */
