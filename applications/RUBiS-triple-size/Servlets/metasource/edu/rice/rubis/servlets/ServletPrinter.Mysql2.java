...
public class ServletPrinter2
{
  private PrintWriter out;
  private String servletName;
  private GregorianCalendar startDate;

  public ServletPrinter2(
  ...
  void printHTMLheader2(String title)
  {
    printFile(Config.HTMLFilesPath + "/header.html");
    out.println("<title>" + title + "</title>");
  }

  void printHTMLfooter2()
  {
  ...
  void printHTML2(String msg)
  {
    out.println(msg);
  }

  void printHTMLHighlighted2(String msg)
  {
  ...
  void printCategory2(String categoryName, int categoryId)
  {
    try
    {
      out.println(
  ...
  void printCategoryByRegion2(String categoryName, int categoryId, int regionId)
  {
    try
    {
      out.println(
  ...
  void printCategoryToSellItem2(String categoryName, int categoryId, int userId)
  {
    try
    {
      out.println(
  ...
  void printRegion2(String regionName)
  {
    try
    {
      out.println(
  ...
  void printItemFooter2()
  {
    out.println("</TABLE>");
  }

  void printItemFooter2(String URLprevious, String URLafter)
  {
    out.println("</TABLE>\n");
    out.println(
      "<p><CENTER>\n"
  ...
  void printUserBoughtItemHeader2()
  {
    printHTML("<br>");
  ...
  void printSellHeader2(String title)
  {
   ...
   */
  void printItemDescriptionToBuyNow2(
    int itemId,
    String itemName,
    String description,
    float buyNow,
  ...
  void printBidHistoryFooter2()
  {
    out.println("</TBODY></TABLE>");
  }

  void printBidHistory2(int userId, String bidderName, float bid, String date)
  {
    try
    {
      out.println(
  ...
  void printCommentHeader2()
  {
    out.println("<DL>");
  }

  void printComment2(String userName, int userId, String date, String comment)
  {
    try
    {
      out.println(
