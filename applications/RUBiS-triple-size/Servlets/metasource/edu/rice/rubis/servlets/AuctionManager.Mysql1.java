...
public class AuctionManager1 extends HttpServlet {
	...
	public void doGet1(HttpServletRequest req, HttpServletResponse res)
...
//	}
	...
	private synchronized void initializeMysqlBackend1() throws ServletException{
	...
	private synchronized void initializeTxMudBackend1() throws ServletException{
		Database.init(); //initialize the connection pool
		initializeTxMudIDFactory(Config.MaxProxyPerDatacenter * Config.DatacenterID+ Config.ProxyID);
	}
	private synchronized void initializeMysqlIDFactory1(int globalProxyId) {
	...
	private synchronized void initializeTxMudIDFactory1(int globalProxyId) {
		PreparedStatement stmt = null;
		Connection con = null;
		con = Database.getConnection();
