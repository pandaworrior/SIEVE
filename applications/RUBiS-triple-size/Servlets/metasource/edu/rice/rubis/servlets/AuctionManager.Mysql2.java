...
public class AuctionManager2 extends HttpServlet {
...
//	}
	...
	private synchronized void initializeMysqlBackend2() throws ServletException{
		Database.init(); //initialize the connection pool
		initializeMysqlIDFactory2(Config.MaxProxyPerDatacenter * Config.DatacenterID+ Config.ProxyID);
	}
	private synchronized void initializeTxMudBackend2() throws ServletException{
		Database.init(); //initialize the connection pool
		initializeTxMudIDFactory2(Config.MaxProxyPerDatacenter * Config.DatacenterID+ Config.ProxyID);
	}
	private synchronized void initializeMysqlIDFactory2(int globalProxyId) {
	...
	private synchronized void initializeTxMudIDFactory2(int globalProxyId) {
		PreparedStatement stmt = null;
		Connection con = null;
		con = Database.getConnection();
