 ...
 */
  ...
  /** List items the user is currently selling and sold in yhe past 30 days */
  private boolean listItem1(Integer userId, Connection conn, ServletPrinter sp)
  {
    ResultSet currentSellings = null;
    ResultSet pastSellings = null;
    PreparedStatement currentStmt = null;
  ...
  private boolean listItem2(Integer userId, Connection conn, ServletPrinter sp)
  {
    ResultSet currentSellings = null;
    ResultSet pastSellings = null;
    PreparedStatement currentStmt = null;
  ...
  /** List items the user bought in the last 30 days*/
  private boolean listBoughtItems1(Integer userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    ResultSet buy = null;
    String itemName, sellerName;
    int quantity, sellerId, itemId;
  ...
  private boolean listBoughtItems2(Integer userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    ResultSet buy = null;
    String itemName, sellerName;
    int quantity, sellerId, itemId;
  ...
  /** List items the user won in the last 30 days*/
  private boolean listWonItems1(Integer userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    int sellerId, itemId;
    float currentPrice, initialPrice;
    String itemName, sellerName;
  ...
  private boolean listWonItems2(Integer userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    int sellerId, itemId;
    float currentPrice, initialPrice;
    String itemName, sellerName;
  ...
  private boolean listComment1(Integer userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    ResultSet rs = null;
    String date, comment;
    int authorId;
  ...
  private boolean listComment2(Integer userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    ResultSet rs = null;
    String date, comment;
    int authorId;
  ...
  /** List items the user put a bid on in the last 30 days*/
  private boolean listBids1(Integer userId, String username, String password, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
  ...
  private boolean listBids2(Integer userId, String username, String password, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
  ...
  throws IOException, ServletException
{
  ...
  connAlive = listBids1(userId, username, password, stmt, conn, sp);
  if (connAlive) {
      connAlive = listItem1(userId, conn, sp);
  }
  if (connAlive) {
      connAlive = listWonItems1(userId, stmt, conn, sp);
  }
  if (connAlive) {
      connAlive = listBoughtItems1(userId, stmt, conn, sp);
  }
  if (connAlive) {
      connAlive = listComment1(userId, stmt, conn, sp);
  }
