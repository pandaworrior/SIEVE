...
//  
  ...
  private boolean categoryList1(int regionId, int userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    String categoryName;
    int categoryId;
    ResultSet rs = null;
  ...
  private boolean categoryList2(int regionId, int userId, PreparedStatement stmt, Connection conn, ServletPrinter sp)
  {
    String categoryName;
    int categoryId;
    ResultSet rs = null;
  ...
  throws IOException, ServletException
{
  ...
  boolean connAlive = categoryList1(regionId, userId, stmt, conn, sp);
  if (connAlive) {
  	Database.commit(conn);
      Database.closeConnection(stmt, conn);
  }
  ...
  throws IOException, ServletException
{
  ...
  boolean connAlive = categoryList2(regionId, userId, stmt, conn, sp);
  if (connAlive) {
  	Database.commit(conn);
      Database.closeConnection(stmt, conn);
  }
